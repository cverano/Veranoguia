...
class Aplicacion:
    ...
    def agregar_componentes(self):
        self.label1=ttk.Label(self.labelframe1, text="Ingrese Nota del Primer Corte:")
        ...
        self.label2=ttk.Label(self.labelframe1, text="Ingrese Nota del Segundo Corte:")
        ...
        self.boton1=ttk.Button(self.labelframe1, text="Calcular", command=self.corte3)
        self.boton1.grid(column=1, row=2, padx=5, pady=5, sticky="we")
        self.boton2=ttk.Button(self.labelframe1, text="Promedio", command=self.promedio)
        self.boton2.grid(column=1, row=3, padx=5, pady=5, sticky="we")
    ...
    def corte3(self):
        if self.dato1.get()=="" or self.dato2.get()=="":
            ...
            val3=24-val2
            val4=val3*(32/10)
            mb.showinfo("Necesita","Usted en el tercer corte necesita:  "+str(val4))

    def promedio(self):
        if self.dato1.get()=="" or self.dato2.get()=="":
            mb.showerror("Cuidado","No dejar espacios vacios")
        else:
            suma=int(self.dato1.get())+int(self.dato2.get())
            val1=suma/2
            mb.showinfo("Promedio","Su Promedio es de:  "+str(val1))

    def acerca(self):
        mb.showinfo("Información", "Este programa fue desarrollado por Carlos Julian Verano Moreno.")
